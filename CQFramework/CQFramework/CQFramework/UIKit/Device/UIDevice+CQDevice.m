...
#import "UIDevice+CQDevice.h"
#include <mach/mach.h>
#include <sys/sysctl.h>
#import "NSString+CQExtension.h"

@implementation UIDevice (CQDevice)

+(double)cqSystemVersion{
...
-(BOOL)isJailbroken{
    ...
    NSString *path = [NSString stringWithFormat:@"/private/%@", [NSString cqCreateUUID]];
