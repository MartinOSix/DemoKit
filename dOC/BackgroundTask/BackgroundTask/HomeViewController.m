...
- (void)viewDidLoad {
    ...
    for (int i = 1; i < 11; i ++) {
        ...
        BackgroundTaskModel *model = [[BackgroundTaskModel alloc]initWithUrl:url];
        [self.dataSource addObject:model];
    }
    BackgroundTaskModel *model = [[BackgroundTaskModel alloc]initWithUrl:@"http://get.videolan.org/vlc/2.2.5.1/macosx/vlc-2.2.5.1.dmg"];
    [self.dataSource addObject:model];
